<script lang="ts">
import type { AppRootContextInterface } from "@/shared";
...
import { setAppRootContext } from "@/shared";

// @todo: https://github.com/telegram-mini-apps-dev/TelegramUI/blob/main/src/components/Service/Appwrapper/Appwrapper.tsx
const props = defineProps<AppRootProps>();

watch(props, setAppRootContext, { immediate: true });
</script>
...
<template>
	<div
		:class="[
			...
			appearance === 'dark' && $style['wrapper--dark'],
		]"
	>
		<slot />
	</div>
...
<style module>
.wrapper {
	--tgui--font-family: system-ui, -apple-system, BlinkMacSystemFont, "Roboto", "Apple Color Emoji", "Helvetica Neue",
		sans-serif;
