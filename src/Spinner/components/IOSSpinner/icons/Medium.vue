<template>
	<svg xmlns="http://www.w3.org/2000/svg" id="m151:1947" width="32" height="32" viewBox="0 0 32 32">
		<g transform="matrix(1,0,0,1,0,0)">
			<g id="m151:1947" opacity="1" style="mix-blend-mode: normal">
				<g>
					<defs>
					...
					<g clipPath="url(#151:1947_clipPath)">
						...
						>
							<g id="m151:1985" opacity="0.837" style="mix-blend-mode: normal">
								<g>
									<g>
										<path
						...
						<g transform="matrix(1,0,0,1,14.5454,21.0909)">
							<g id="m151:1980" opacity="0.467" style="mix-blend-mode: normal">
								<g>
									<g>
										<path
						...
						>
							<g id="m151:1982" opacity="0.153" style="mix-blend-mode: normal">
								<g>
									<g>
										<path
						...
						<g transform="matrix(6.123233995736766e-17,-1,1,6.123233995736766e-17,21.0909,17.4545)">
							<g id="m151:1984" opacity="0.049" style="mix-blend-mode: normal">
								<g>
									<g>
										<path
						...
						>
							<g id="m151:1986" opacity="0.01" style="mix-blend-mode: normal">
								<g>
									<g>
										<path
						...
						<g transform="matrix(1,0,0,1,14.5454,1.4545)">
							<g id="m151:1979" opacity="0" style="mix-blend-mode: normal">
								<g>
									<g>
										<path
						...
						>
							<g id="m151:1981" opacity="0" style="mix-blend-mode: normal">
								<g>
									<g>
										<path
						...
						<g transform="matrix(6.123233995736766e-17,-1,1,6.123233995736766e-17,1.4545,17.4545)">
							<g id="m151:1983" opacity="1" style="mix-blend-mode: normal">
								<g>
									<g>
										<path
